...
*Auto-generated: 2026-05-16 13:41*
...
| `utils/watchdog_deos.py` | Watchdog DEOS supervisor. |
...
| `fridays/scheduler_daemon.py` | Standalone scheduler loop for Fridays. |
...
| `exec_bp` | 6 | exec_bp.py — Ghost Exec routes |
...
| `git` | 12 | git.py — Git Operations routes |
...
| `killswitch` | 7 | killswitch.py — Kill Switches routes |
...
| `mac_download` | 0 | Serve macOS install instructions and source tarball for Seven Desktop. |
...
| `change_runs` | 46 |
| `chat_jobs` | 863 |
| `chat_relay_recoveries` | 95 |
| `claude_log` | 1 |
| `conv_timeline` | 7465 |
| `conversations` | 144 |
| `council_output` | 19914 |
...
| `kc_media_trace` | 13 |
| `knowledge_chunks` | 1738 |
| `knowledge_sources` | 146 |
| `media_items` | 1 |
| `media_jobs` | 1 |
| `media_providers` | 7 |
| `media_runs` | 183 |
...
| `orientation_seen` | 1 |
| `pending_emails` | 8 |
| `project_blackboard_notes` | 193 |
| `project_doc_versions` | 392 |
| `project_docs` | 329 |
| `project_step_deps` | 0 |
| `project_step_evidence` | 1091 |
| `project_steps` | 1639 |
...
| `queue` | 2169 |
| `research_evidence` | 1786 |
| `research_sessions` | 99 |
| `sandpit_log` | 646 |
| `scheduled_tasks` | 25 |
| `service_heartbeat` | 0 |
...
| `settings_sysmod` | 2 |
| `seven_attention` | 4873 |
| `seven_beliefs` | 10753 |
| `seven_callouts` | 11 |
| `seven_concepts` | 9 |
| `seven_episodes` | 26288 |
| `seven_learnings` | 1 |
| `seven_settings` | 0 |
| `skills` | 47 |
| `sniffer_log` | 232 |
...
| `video_timelines` | 25 |
| `watchdog_repair_lessons` | 51 |
| `watched_topic_evidence` | 226 |
