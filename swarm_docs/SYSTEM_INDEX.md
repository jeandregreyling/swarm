...
*Auto-generated: 2026-05-01 22:47*
...
| `core/platform.py` | core.platform — runtime capability detection for the swarm. |
...
| `enrollment` | 3 | frontend/blueprints/enrollment.py — user-account enrolment endpoints. |
...
| `knowledge_bp` | 42 | Knowledge Center blueprint. |
...
| `pending_emails` | 8 |
| `project_blackboard_notes` | 42 |
| `project_doc_versions` | 289 |
| `project_docs` | 249 |
| `project_steps` | 754 |
