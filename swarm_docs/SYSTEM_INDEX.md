...
*Auto-generated: 2026-05-15 00:12*
...
| `change_runs` | 46 |
| `chat_jobs` | 820 |
| `chat_relay_recoveries` | 89 |
| `claude_log` | 1 |
| `conv_timeline` | 5536 |
| `conversations` | 136 |
| `council_output` | 19054 |
...
| `orientation_seen` | 1 |
| `pending_emails` | 8 |
| `project_blackboard_notes` | 186 |
| `project_doc_versions` | 392 |
| `project_docs` | 326 |
| `project_step_deps` | 0 |
| `project_step_evidence` | 481 |
| `project_steps` | 1575 |
...
| `queue` | 2162 |
| `research_evidence` | 1678 |
| `research_sessions` | 93 |
| `sandpit_log` | 646 |
| `scheduled_tasks` | 23 |
| `service_heartbeat` | 0 |
...
| `settings_sysmod` | 2 |
| `seven_attention` | 4862 |
| `seven_beliefs` | 10722 |
| `seven_callouts` | 11 |
| `seven_concepts` | 9 |
| `seven_episodes` | 26258 |
| `seven_learnings` | 1 |
| `seven_settings` | 0 |
| `skills` | 47 |
| `sniffer_log` | 232 |
