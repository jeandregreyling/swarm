...
*Auto-generated: 2026-05-16 00:11*
...
| `orientation_seen` | 1 |
| `pending_emails` | 8 |
| `project_blackboard_notes` | 192 |
| `project_doc_versions` | 392 |
| `project_docs` | 327 |
| `project_step_deps` | 0 |
| `project_step_evidence` | 595 |
| `project_steps` | 1583 |
...
| `settings_sysmod` | 2 |
| `seven_attention` | 4871 |
| `seven_beliefs` | 10748 |
| `seven_callouts` | 11 |
| `seven_concepts` | 9 |
| `seven_episodes` | 26282 |
| `seven_learnings` | 1 |
| `seven_settings` | 0 |
| `skills` | 47 |
| `sniffer_log` | 232 |
