...
doc('04_files.docx', 'File Reference', [
    ...
    ('Templates (/home/seven/swarm/templates/)', [
        '• terminal.html — the entire dashboard. ~2400 lines. Dark UI. SSE streaming. All views: Chat, Memory, Tickets, Agents, System, Sandpits, Skills, Monitor, Docs.',
    ]),
