...
- `Time Wizard Test Suite`
	- Action: opens Time Wizard test suite document in the doc detail modal.
...
2. Review (Who: Ghost governance)
- Why: prevent unapproved mutating actions.
- What: Studio Pending queue decision (approve/reject).

3. Execute (Who: runtime endpoints under ALM gate)
