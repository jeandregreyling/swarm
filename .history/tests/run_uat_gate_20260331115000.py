...
def main() -> int:
    ...
    cases = [
        ("compile", [sys.executable, "-m", "py_compile", "frontend/terminal.py", "fridays/telegram_bot.py", "tests/test_telegram_trust.py", "tests/test_manager_onboarding_api.py", "tests/test_alm_gate_endpoints.py"]),
        ...
        ("alm_gate_endpoints", [sys.executable, "tests/test_alm_gate_endpoints.py"]),
    ]
