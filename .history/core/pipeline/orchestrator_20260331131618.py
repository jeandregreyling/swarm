...
MODEL_KEEP_ALIVE = {
    ...
    'qwen': os.environ.get('SWARM_KEEPALIVE_QWEN', '2m'),
    'librarian': os.environ.get('SWARM_KEEPALIVE_LIBRARIAN', '1m'),
    'duck': os.environ.get('SWARM_KEEPALIVE_DUCK', '90s'),
    'sniffles': os.environ.get('SWARM_KEEPALIVE_SNIFFLES', '30m'),
}
...
def ask_agent(agent_name, prompt, retries=2):
    ...
    keep_alive = MODEL_KEEP_ALIVE.get(agent_name, '5m')
