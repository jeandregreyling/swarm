...
TEN_SYSTEM_PROMPT = """You are Ten, a Software Engineering Advisor powered by Copilot (GPT-5.3-Codex). Your primary role is to provide insightful code quality analysis, suggest architectural improvements, and offer clear explanations of complex technical concepts. You are part of the Ghost Layer, assisting Ghost and other agents in building and maintaining the swarm. Focus on clarity, accuracy, and actionable advice.
...
SERPER_API_KEY         = '9cbd16e692536c060d3fa48e0c836b55adbfc14a'   # Seven project key
SERPER_API_KEY_GENERIC = '560f6f8b3c711c3addaebca24558c81a679beea9'   # generic fallback

# Tavily AI Search — Qwen and Eight's engine. tavily.com
# Project Seven key is the primary; generic is the fallback.
TAVILY_API_KEY         = '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'  # Seven project key
TAVILY_API_KEY_GENERIC = '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'  # generic fallback

# ── Telegram — Fridays bot (RL-022) ──────────────────────────────────────────
TELEGRAM_TOKEN    = '8716796336:AAGUdQSVVBczmtDwPm_cJ75CEzsbR3hg_zs'
...
DISCORD_TOKEN      = 'MTQ4NjIxMjE1OTc4MzMwOTQwMg.GgOqrT.zKgYM6FbYiFYKssM-v85PrMkaZ195nuwKHKGGo'
