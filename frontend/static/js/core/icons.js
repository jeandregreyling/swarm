...
const windowIcons = {
  'chat':          '<svg viewBox="0 0 16 16" width="14" height="14" fill="none"><path d="M3 4.5h10v6H7l-3 2v-2H3z" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round"/></svg>',
  'terminal':      '<svg viewBox="0 0 16 16" width="14" height="14" fill="none"><path d="M2.5 3.5h11v9h-11zM5 6l2 2-2 2M8.5 10h2.5" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/></svg>',
